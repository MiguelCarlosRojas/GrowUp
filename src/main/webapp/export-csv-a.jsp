...
<%
    ...
    try {
        ...
        // Consulta SQL para obtener los registros con estado "A" y ordenados
        String query = "SELECT names, last_name, type_document, number_document, email, cell_phone, rol, active FROM dbo.person WHERE active = 'A' ORDER BY names";
        ...
        response.setHeader("Content-Disposition", "attachment; filename=active_persons.csv");
