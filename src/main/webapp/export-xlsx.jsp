...
<%
  ...
  try {
    ...
    // Obtener los datos de la tabla "person" con estado "A" o "I"
    String selectQuery = "SELECT * FROM dbo.person WHERE active IN ('A', 'I')";
    ...
    while (rs.next()) {
      ...
      // Crear una nueva fila en el libro de Excel solo si el estado es "A" o "I"
      if (active.equals("A") || active.equals("I")) {
