...
<%
  ...
  try {
    ...
    // Obtener los datos de la tabla "person" con estado "A"
    String selectQuery = "SELECT * FROM dbo.person WHERE active = 'A'";
    ...
    while (rs.next()) {
      ...
      // Agregar una fila a la tabla con los datos de la persona solo si el estado es "A"
      if (active.equals("A")) {
    ...
    response.setHeader("Content-Disposition", "attachment;filename=active_persons.pdf");
