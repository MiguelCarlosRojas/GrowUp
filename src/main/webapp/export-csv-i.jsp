...
<%
    ...
    try {
        ...
        // Consulta SQL para obtener los registros con estado "I" ordenados
        String query = "SELECT names, last_name, type_document, number_document, email, cell_phone, rol, active FROM dbo.person WHERE active = 'I' ORDER BY names";
        ...
        response.setHeader("Content-Disposition", "attachment; filename=inactive_person_report.csv");

        // Obtener el flujo de salida de la respuesta
        CSVWriter csvWriter = new CSVWriter(response.getWriter());

        // Escribir el encabezado del archivo CSV
        csvWriter.writeNext(new String[]{"Nombres", "Apellidos", "Tipo de Documento", "Numero de Documento", "Email", "Telefono Celular", "Rol", "Estado"});
        ...
        while (resultSet.next()) {
            ...
            csvWriter.writeNext(new String[]{names, last_name, type_document, number_document, email, cell_phone, rol, active});
        }
